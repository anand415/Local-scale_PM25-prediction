...
pipe = Pipeline([
        ...
        ('reg', SVR(kernel='rbf', C=820, gamma=967,epsilon=0.2))])# svr = SVR(kernel='rbf', C=1e1, gamma=0.1)
...
# data = {'scores4C' : scores}
# m4p.savemat('scores4C.mat', data)  
...
# xgb,lgb,cbr,rf
with open("comp4Cchk.txt",'w',encoding='utf-8') as file1:
    for ii in range(0,5):
