...
AMD=loadmat('pm25_regression3.mat')
#%%
X=AMD["matR3add2"][:,[0,1,2,4]]
Y=AMD["matR3add2"][:,5]
...
pipe = Pipeline([
        ...
        ('reg', SVR(kernel='rbf', C=869, gamma=903,epsilon=0.2))])# svr = SVR(kernel='rbf', C=1e1, gamma=0.1)
...
# xgb,lgb,cbr,rf
with open("comp3C.txt",'w',encoding='utf-8') as file1:
    for ii in range(0,5):
